...
if (isset($_POST['signupsubmit'])) {
    ...
    */
    ...
    $email = input_filter($_POST['email'] . "@lpu.edu.ph");
    ...
    $program = input_filter($_POST['program']);
    ...
    */
    ...
    if (empty($username) || empty($email) || empty($password) || empty($passwordRepeat)) {
        ...
        */
        ...
        $stmt->execute([$username, $email, $hashedPwd, $first_name, $last_name, $gender, $headline, $bio, $FileNameNew, $program]);
