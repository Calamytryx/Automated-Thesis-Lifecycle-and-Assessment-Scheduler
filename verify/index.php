...
if (isset($_SESSION['STATUS']['verify']) && $_SESSION['STATUS']['verify'] === 'Your account has been verified. You can now log in.') {
    $_SESSION['auth'] = 'verified';
    $redirectToHome = true;
}

if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['updateemailsubmit'])) {
    // Validate new email prefix
    ...
    require_once '../assets/setup/db.inc.php'; // Load PDO
            ...
            <form action="includes/sendverificationemail.inc.php" method="post">
                ...
                <div class="text-center mt-5">
                    <h6 class="text-success">
                        ...
                        ?>
                        <?php if (isset($redirectToHome) && $redirectToHome): ?>
                            <br><small class="text-muted">Redirecting to homepage in 5 seconds...</small>
                        <?php endif; ?>
                    </h6>
                </div>
            </form>
...
<?php if (isset($redirectToHome) && $redirectToHome): ?>
  <script>
    // ✅ Smooth redirect after showing message
    setTimeout(() => {
