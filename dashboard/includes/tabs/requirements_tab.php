...
<div class="tab-pane fade" id="requirements" role="tabpanel" aria-labelledby="requirements-tab">
    <div class="d-flex justify-content-between align-items-center mb-3 my-3">
        <button class="btn feature-btn add-btn" data-table="requirements">
                        ...
                        tbody.innerHTML += `
                            ...
                            <td class="action-buttons">
                                <div class="d-flex gap-2 justify-content-center">
                                    <button class="btn btn-sm edit-btn" data-table="requirements" data-id="${requirement.id}">
                                        <i class="fas fa-edit me-1"></i>Edit
                                    </button>
                                    <button class="btn btn-sm delete-btn" data-table="requirements" data-id="${requirement.id}">
