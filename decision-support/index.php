        ...
        $('.rubric-card').each(function() {
            ...
            if (rubricType === 'numerical') {
                    ...
                    if (isIndividualCriterion) {
                        ...
                        if (scoreInput.length > 0) {
                            ...
                            if (score !== '') { // Check if score is not empty
                                ...
                                scores[criterionId] = { 'group': score };
                            }
                        }
                    }
                });
                 if (Object.keys(scores).length > 0) {
                     rubricResult = { scores: scores }; // Store numerical scores under 'scores' key
                 }
                 ...
                 $(this).find('tbody tr[data-criterion-id]').each(function() {
                     ...
                     if (isIndividualCriterion) {
                         ...
                         if (checkedValue !== undefined) {
                             options[criterionId] = { 'group': checkedValue };
                         }
                     }
                 });
                 if (Object.keys(options).length > 0) {
                     rubricResult = { options: options }; // Store yes/no options under 'options' key
                 }
                ...
                if (selectedOption !== undefined) {
                    ...
                    rubricResult = { selected_option: selectedOption };
                } else {
