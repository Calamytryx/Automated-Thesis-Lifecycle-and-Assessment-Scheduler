...
if (!defined('APP_LOGO_NAVBAR'))   define('APP_LOGO_NAVBAR', getEnvVariable('APP_LOGO_NAVBAR') ?? '../images/logo_full_lightbg.png');
if (!defined('APP_LOGO_FOOTER'))  define('APP_LOGO_FOOTER', getEnvVariable('APP_LOGO_FOOTER') ?? '../images/logowhite.png');
